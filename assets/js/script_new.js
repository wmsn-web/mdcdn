(function($) {
    ...
    if ($('.pharmacy-home-slider_2 .swiper-container').length > 0) {
        var swiper = new Swiper('.pharmacy-home-slider_2 .swiper-container',{
            loop: true,
            speed: 1000,
            autoplay: true,
            pagination: {
                el: '.pharmacy-home-slider_2 .swiper-pagination',
                dynamicBullets: true,
                clickable: true,
            },
            navigation: {
                nextEl: '.pharmacy-home-slider_2 .swiper-button-next',
                prevEl: '.pharmacy-home-slider_2 .swiper-button-prev',
            },
        });
    }
